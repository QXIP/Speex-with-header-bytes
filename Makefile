...
ACLOCAL = ${SHELL} /usr/src/speex-1.2rc1-qmod/missing --run aclocal-1.8
AMDEP_FALSE = #
AMDEP_TRUE = 
AMTAR = ${SHELL} /usr/src/speex-1.2rc1-qmod/missing --run tar
AR = ar
AS = as
AUTOCONF = ${SHELL} /usr/src/speex-1.2rc1-qmod/missing --run autoconf
AUTOHEADER = ${SHELL} /usr/src/speex-1.2rc1-qmod/missing --run autoheader
AUTOMAKE = ${SHELL} /usr/src/speex-1.2rc1-qmod/missing --run automake-1.8
AWK = mawk
...
MAKEINFO = ${SHELL} /usr/src/speex-1.2rc1-qmod/missing --run makeinfo
NMEDIT = 
OBJDUMP = objdump
OBJEXT = o
OGG_CFLAGS = 
...
install_sh = /usr/src/speex-1.2rc1-qmod/install-sh
